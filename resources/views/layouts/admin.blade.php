				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Booking</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ asset('/booking') }}">Booking Request</a></li>
							<li><a href="{{ asset('/booklist') }}">Booking List</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Database</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ asset('/vehicles') }}">Vehicle List</a></li>
							<li><a href="{{ asset('/driver/list') }}">Driver List</a></li>
						</ul>
					</li>
					<li>
